...
where $S$ is the total number of spectral features used in the inference. Here we have assumed that $P(s_{o}|\theta, t_{obs})$ are all independent of each other and that the errors on the observed features, $\sigma_{s, o}$, are also independent and Gaussian (a simplifying assumption but difficult to otherwise constrain). To obtain the probability of a set of $\theta$ values, i.e. a SFH model, given the observed spectral features: $P(\theta|\vec{d}_{s,o}, t_{obs})$, we utilise Bayes' theorem as:
...
Red ellipticals         & 0.11   &  $1_{1}^{1}$ &  0.32  &    $1_{1}^{1}$   &  12   &   $2_{2}^{13}$   &  966  &   $996_{6}^{1}$   \\
Red early-type spirals  & 0.65   &  $10_{9}^{19}$ &  2.4   &  $22_{21}^{44}$     &  36   &   $244_{241}^{488}$  &  960  &  $997_{276}^{1}$    \\
Red late-type spirals   &  1.9   &  $61_{59}^{121}$  &  5.6   &   $113_{111}^{225}$    &  59   &   $315_{311}^{630}$   &  933  &   $997_{501}^{1}$    \\ \hline
Blue ellipticals        &  2.5   &  $108_{107}^{217}$   &  11    &   $186_{184}^{372}$    &  52   &   $319_{315}^{637}$   &  934  &     $997_{638}^{1}$ \\
Blue early-type spirals &  4.9   &  $80_{79}^{46}$  &  14    &   $134_{133}^{74}$    &  42   &   $211_{209}^{86}$   &  938  &  $554_{217}^{437}$     \\
Blue late-type spirals  &  6.1   &  $67_{66}^{58}$  &  11    &   $113_{109}^{94}$    &  43   &    $187_{184}^{113}$  &  939  & $615_{279}^{372}$                              
\end{tabular*}
\end{table*}
